...
### Example Command: Rscript DESeq.R matfile.mat cell,cell,cell,exosomes,exosomes,exosomes /projects/project_name mature_sense_minExpr5_RCadj

#/opt/local/R-3.5.3/bin/Rscript /opt/sRNAtoolboxDB/r/de_deseq2.R mature_sense_minExpr1_RCadj.mat exosome,exosome,exosome,exosome,exosome,exosome,cell,cell,cell,cell,cell,cell /opt/sRNAtoolbox_prod/sRNAtoolboxweb/upload/32E6QU5QY1P9I2V/de/de_deseq2 mature_sense_minExpr1_RCadj
